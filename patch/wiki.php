...
#
# IFramed Plugin PATCH
#
# Replace the default wiki.php file in your mantisbt installation with this one to use
# the IFramed plugin to open the Wiki embedded into the MantisUI using an iframe
#
# - spmeesseman
#
